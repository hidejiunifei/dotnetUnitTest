...
namespace GenerateUnitTest
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SplitHandler
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("24676142-23f8-4b5b-8c2a-cc6333889260");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SplitHandler"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private SplitHandler(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static SplitHandler Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in SplitHandler's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new SplitHandler(package, commandService);
        }
        ...
        private async void Execute(object sender, EventArgs e)
        {
            ...
            if (null != selectedItems)
            {
                foreach (UIHierarchyItem selItem in selectedItems)
                {
                    ...
                    foreach (MethodDeclarationSyntax member in classDeclaration.Members.Where(x => x is MethodDeclarationSyntax 
